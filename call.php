...
Author : Clone Dwiki Gans
Fungsi : anda sakit hati dengan mantan anda gunakan tools ini               
Team   : Xploiter Hacker Team                 
Github : https//github.com/mr-clon3/\n\n\e[0;1m";
                                                                                 
                                                                                                                                                                 
sleep(3);
echo $banner;
sleep(2);
echo "masukan list target cok : ";
